...
%>
	...
	<div style="position:absolute;top:150px;left:550px;font-family:FangSong;font-size:30px;">
		...
		<Button style="width:150px;height:32px;font-family:FangSong;font-size:20px;" onclick="window.location.href='ShowBooksByPageServlet?pagenum=<%= pagenum-1%>'">上一页</Button>
		<Button style="width:150px;height:32px;font-family:FangSong;font-size:20px;" onclick="window.location.href='ShowBooksByPageServlet?pagenum=<%= pagenum+1%>'">下一页</Button>
	</div>
